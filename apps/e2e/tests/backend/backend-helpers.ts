...
import { BACKEND_BASE_URL, Context, INTERNAL_PROJECT_ADMIN_KEY, INTERNAL_PROJECT_CLIENT_KEY, INTERNAL_PROJECT_ID, INTERNAL_PROJECT_SERVER_KEY, Mailbox, NiceResponse, createMailbox, niceFetch } from "../helpers";
...
export const InternalProjectKeys = {
  ...
  publishableClientKey: INTERNAL_PROJECT_CLIENT_KEY,
  secretServerKey: INTERNAL_PROJECT_SERVER_KEY,
  superSecretAdminKey: INTERNAL_PROJECT_ADMIN_KEY,
};
